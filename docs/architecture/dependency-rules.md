...
authorization boundary, IT2 added Ticket persistence/domain commands, and IT3
added requester-scoped Ticket API/query and Dashboard presentation. No Ticket
notification producer exists yet. Email Request ownership migration remains
deferred to IT8. Legacy IT notification and outbox enum values remain
