...
หัวข้อนี้เป็น risk register ที่สืบทอดจาก Phase 0/Phase 1 และใช้เป็นหลักฐานของ policy ที่ยังไม่ถูกตัดสิน; current phase status และการจัดประเภทล่าสุดอยู่ใน Phase 11D closure และ [authorization-phase-11a-audit.md](authorization-phase-11a-audit.md)
