...
- Routine, Stock และ Leave server migrated paths ใช้ central resolver พร้อม domain-owned resource semantics และ compatibility floors ตาม migration records; Department, Notification และ Employee ใช้ central resolver ร่วมกับ permanent Default Domain Policy และ Phase 12B additive composition. Employee presentation และ complete-surface audit/regression hardening ของ current production surface ปิดแล้วใน Phase 8B/8C ตามลำดับ, Phase 9B presentation integration ของ Department/Audit/Notification ปิดแล้ว, และ Phase 9C closure audit ของ current migrated production surface ปิดแล้ว. รายละเอียด current Phase 12C.2 อยู่ใน [authorization-phase-12c2-employee-additive-migration.md](authorization-phase-12c2-employee-additive-migration.md)
...
composition. Phase 12C.1 migrated Department + Notification and Phase 12C.2
migrated Employee to this seam. Routine, Stock, and Leave remain on their
documented compatibility mechanics until their own migrations.
...
TeamRole, and direct User commands. Routine, Stock, and Leave remain
compatibility-backed; deferred Routine surfaces and Email Request/future IT
remain outside this phase. The Administration inspector continues to show
...
The next handoff is Phase 12C.3 — Routine Additive Default Policy Migration.
