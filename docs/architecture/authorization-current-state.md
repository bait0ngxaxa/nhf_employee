...
สถานะ: Baseline Phase 0 พร้อมบันทึก migration ถึง Phase 8A; Employee server authorization migration — CLOSED; Leave authorization migration — CLOSED; Employee presentation Phase 8B — NOT STARTED; Employee complete-surface audit Phase 8C — NOT STARTED<br>
...
- Employee list/stats/export remain organization-wide according to their existing query implementations; explicit USER ALLOW is honored without changing query scope, while Employee presentation capability migration is deferred to Phase 8B
