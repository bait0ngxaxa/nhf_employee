...
import { getCurrentLeaveYear } from "../../domain/quota-year";
            ...
            <YearlyReportExportPanel
                ...
                badge={
                    <div className="space-y-3">
                        <div className="inline-flex rounded-full border border-brand-border-default bg-brand-surface px-3 py-1 text-xs font-medium text-brand-heading">
                            {getScopeLabel(scope)}
                        </div>
