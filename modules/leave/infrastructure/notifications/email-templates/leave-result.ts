import { type LeaveResultPayload } from "@/modules/leave/application/notifications/notification-payloads";
import {
...
import { escapeHtml, textToHtml } from "@/lib/email/templates/html";
