...
import { generateStockRequestResultEmailHTML } from "../infrastructure/notifications/email-template/stock-request-result";
...
describe("Stock email template XSS escaping", () => {
