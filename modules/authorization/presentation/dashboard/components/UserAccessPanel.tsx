        ...
        <div className="space-y-5">
            ...
            {user ? (
                <div className="space-y-5">
                    ...
                    <section className="space-y-4" aria-labelledby="authorization-user-information-heading">
...
function DirectUserGrantSummary({
    ...
    return (
        <section className="border-t border-action-primary-solid/35 pt-3" aria-labelledby={`personal-grant-${capability.key}`}>
...
function InlineUserGrantEditor({
    ...
    return (
        <section id={`personal-grant-editor-${capability.key}`} className="mt-3 border-t border-action-primary-solid/35 pt-3" aria-labelledby={`personal-grant-${capability.key}`}>
