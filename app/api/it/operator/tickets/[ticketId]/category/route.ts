...
import { setITTicketCategory, setITTicketCategoryBodySchema } from "@/modules/it";
...
export async function PATCH(
    ...
    return patchITOperatorTicket(request, ticketId, setITTicketCategoryBodySchema, setITTicketCategory);
}
