...
import { changeRoutineOccurrenceStatus } from "@/lib/services/routine";
import {
...
export async function PATCH(
    ...
    try {
        ...
        const parsed = routineOccurrenceStatusSchema.safeParse(body.body);
        if (!parsed.success) {
        ...
        const occurrence = await changeRoutineOccurrenceStatus(
        ...
        return routineErrorResponse(error, "Error changing routine occurrence status");
    }
}
