...
const badgeVariants = cva(
  "inline-flex max-w-full min-w-0 items-center justify-center rounded-md border px-2 py-0.5 text-center text-xs font-medium leading-5 [overflow-wrap:anywhere] [&>svg]:size-3 [&>svg]:shrink-0 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-colors overflow-hidden",
  {
    variants: {
      variant: {
        default:
