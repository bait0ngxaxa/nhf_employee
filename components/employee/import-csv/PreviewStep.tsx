    ...
    return (
        <Card className="rounded-2xl border-border-subtle bg-surface-raised shadow-sm">
            ...
            <CardContent className="space-y-6">
                <div className="rounded-xl border border-action-primary-border-subtle bg-action-primary-surface px-4 py-3 text-sm leading-6 text-action-primary-emphasis [overflow-wrap:anywhere]">
                                ...
                                >
                                    ...
                                    <td className="max-w-44 px-4 py-4 text-sm text-content-neutral-secondary">
                                        {employee.nickname?.trim() ? (
                                            <Badge variant="secondary" className="max-w-full border border-employee-nickname-border/60 bg-employee-nickname-surface px-2.5 font-medium text-employee-nickname-foreground hover:bg-employee-nickname-surface-strong [overflow-wrap:anywhere]">
                                                {employee.nickname.trim()}
                                            </Badge>
                                        ) : (
                                            "-"
