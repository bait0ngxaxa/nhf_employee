    ...
    return (
        ...
        >
            <div className="space-y-5">
                <section className="relative overflow-hidden rounded-3xl border border-brand-border bg-brand-surface p-5 shadow-sm sm:p-7">
                    <div className="pointer-events-none absolute -right-12 -top-14 size-40 rounded-full bg-brand-surface-strong/70" />
                    <div className="relative space-y-4">
                        <div className="flex items-center justify-between gap-3">
                            ...
                            <span
                                className={cn(
                                    "rounded-full border border-transparent px-3 py-1.5 text-xs font-bold",
                                    enabled
                        ...
                        <div className="space-y-2">
                            ...
                            <h1 className="max-w-[18ch] text-2xl font-bold leading-tight tracking-tight text-content-heading sm:text-3xl">
