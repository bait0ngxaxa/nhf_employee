...
export function LiffRoutineTaskCard({
    ...
    return (
        <Card
            className={`gap-0 rounded-2xl border bg-surface-raised p-0 shadow-sm ${
                isFocused
        ...
        >
            <button
                ...
                className="group flex min-w-0 flex-col gap-3 rounded-2xl px-4 py-4 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-brand-focus/60 sm:gap-4 sm:px-5"
            >
                {isFocused ? (
                ...
                <div className="flex min-w-0 flex-col items-start gap-2.5 min-[400px]:flex-row min-[400px]:justify-between min-[400px]:gap-3">
                    ...
                    <div className="flex max-w-full shrink-0 items-center gap-2">
                        <span
                            className={`max-w-full whitespace-normal rounded-full border px-2.5 py-1 text-left text-xs font-semibold leading-5 min-[400px]:whitespace-nowrap ${statusClass}`}
                        >
                            {statusLabel}
                        </span>
                        <ChevronRight
